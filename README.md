...
- [x] Explain what a token is used for.
      Tokens are used for identifying an individual login or user, used to continously verify your identity online.

- [x] What steps can you take in your web apps to keep your data secure?
      Don't Submit your token to github, place in .gitignore

- [x] Describe how web servers work.
      Just another computer storing token and personal data. Create, Read, Update, Delete.
